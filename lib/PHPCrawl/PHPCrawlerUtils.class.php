...
class PHPCrawlerUtils
{
  ...
  /**
   * Checks wether the given string is an urlencoded string.
   * 
   * @param string $string The string
   * @return bool TRUE if the string is urlencoded encoded.
   */
  public static function isUrlEncodedString($string)
  { 
    if (rawurldecode($string) == $string) return false;
    else return true;
  }
}
?>
